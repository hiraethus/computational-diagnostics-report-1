...
\subsection{Running the script}
The Gene Ontology Analysis is part of the same script used in Section~\ref{sec:genexpression}.
...
<<results=tex>>=
xtab.go <- xtable(bp.top.15[c(1,2,6)], caption = "Top 15 GO results", label="tab:top15go")
print(xtab.go)
@
